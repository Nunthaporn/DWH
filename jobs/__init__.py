...
from .update_agent_id import update_agent_id_on_fact
from .update_car_id import update_car_id_on_fact
from .update_company_id import update_company_id_job
from .update_payment_plan_id import update_payment_plan_id_on_fact
from .update_order_type_id import update_order_type_id_on_fact
...
from schedules.schedules import update_company_id_schedule
...
defs = Definitions(
    ...
    jobs=[dim_company_etl,dim_agent_etl,dim_car_etl,fact_check_price_etl,
          fact_installment_payments_etl, fact_sales_quotation_etl,
          fact_commission_etl,dim_card_agent_etl,fact_insurance_motor_etl,
          update_agent_id_on_fact,update_car_id_on_fact,update_company_id_job,
          update_payment_plan_id_on_fact,update_order_type_id_on_fact,], 
    schedules=[dim_company_schedule,dim_agent_schedule, dim_car_schedule,
               fact_check_price_schedule,fact_installment_payments_schedule,
               fact_sales_quotation_schedule, fact_commission_schedule,dim_card_agent_schedule,
               fact_insurance_motor_schedule,update_agent_id_schedule,update_car_id_schedule,update_company_id_schedule,
