...
defs = Definitions(
    assets=assets,
    jobs=[dim_company_etl, dim_sales_etl,dim_agent_etl,dim_car_etl,fact_check_price_etl,dim_customer_etl], 
    schedules=[dim_company_schedule,dim_sales_schedule,dim_agent_schedule, dim_car_schedule,fact_check_price_schedule,dim_customer_schedule ],              
)
